...
/**
 * Selector used for determining disable state for the meeting bookmark button.
 *
 * @param {Object} state - The redux state to search in.
 * @returns {string}
 */
export function isMeetingBookmarkButtonDisabled(state: Object) {
    return state['features/recording'].disableMeetingBookmarkButton;
}
